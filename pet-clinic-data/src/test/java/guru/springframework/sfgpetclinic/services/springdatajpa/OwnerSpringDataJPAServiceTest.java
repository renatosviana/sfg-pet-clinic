...
class OwnerSpringDataJPAServiceTest { //refactoring -- tests for CRUD
    ...
    void delete() {
        ...
        //Default is 1 for times
        verify(ownerRepository, times(1)).delete(any()); //refactoring - good example to use verify -- no return
...
//        when(ownerRepository.findByLastName(any())).thenReturn(returnOwner);
        when(ownerRepository.findByLastName(any())).thenReturn(returnOwner); //refactoring
